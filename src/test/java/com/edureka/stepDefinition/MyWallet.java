...
public class MyWallet extends AllFunctionality {
	...
	// Step to validate promotional credits section visibility
	...
	// Step to validate referral credits section visibility
	...
	// Step to validate account balance amount is displayed
	...
	// Step to validate account balance format
	...
	// Step to validate promotional credits amount
	...
	// Step to validate promotional credits value
	...
	// Step to validate referral credits amount
	...
	// Step to validate referral credits value
